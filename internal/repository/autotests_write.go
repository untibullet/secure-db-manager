...
func (r *AppRepository) CreateAutotest(ctx context.Context, dto AutotestDTO) (int, error) {
...
func (r *AppRepository) UpdateAutotest(ctx context.Context, id int, dto AutotestDTO) error {
...
func (r *AppRepository) CreateAutotestVersion(ctx context.Context, autotestID int, dto VersionDTO) (int, error) {
