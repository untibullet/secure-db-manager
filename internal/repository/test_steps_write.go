...
func (r *AppRepository) CreateTestCase(ctx context.Context, dto TestCaseDTO) (int, error) {
...
func (r *AppRepository) UpdateTestCase(ctx context.Context, id int, dto TestCaseDTO) error {
...
func (r *AppRepository) CreateTestCaseStep(ctx context.Context, tcID int, dto StepDTO) (int, error) {
...
func (r *AppRepository) UpdateTestCaseStep(ctx context.Context, id int, dto StepDTO) error {
	sql := `
